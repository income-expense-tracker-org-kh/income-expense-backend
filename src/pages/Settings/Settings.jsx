...
const Settings = () => {
  ...
  console.log("budgets", totalBudget)
  ...
  useEffect(() => {
    ...
    fetchAllIncome();
    fetchBudgets();
  }, [fetchAllExpenses, fetchAllIncome, fetchBudgets]);
              ...
              {sections.map((section) => {
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center gap-2 p-4 rounded-lg transition-colors ${activeSection === section.id
                ...
                <div className="card">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                      ...
                      <p className="text-2xl font-bold text-blue-700 dark:text-blue-300">{filteredTransactions.length}</p>
                    </div>
                    <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
                      <p className="text-sm text-green-600 dark:text-green-400 mb-1">{t("settings.budgets")}</p>
                      <p className="text-2xl font-bold text-green-700 dark:text-green-300">{formatCurrency(totalBudget, currency)}</p>
                    </div>
