              ...
              <div className="card">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">This will be used for all financial calculations and displays</p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Select your preferred language for the interface</p>
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">How dates will be displayed throughout the application</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-4 mt-2">
                      <div className="text-center"><div className="w-full h-16 bg-primary-600 rounded-lg mb-2"></div><span className="text-xs text-gray-600 dark:text-gray-400">Primary</span></div>
                      <div className="text-center"><div className="w-full h-16 bg-income rounded-lg mb-2"></div><span className="text-xs text-gray-600 dark:text-gray-400">Income</span></div>
                      <div className="text-center"><div className="w-full h-16 bg-expense rounded-lg mb-2"></div><span className="text-xs text-gray-600 dark:text-gray-400">Expense</span></div>
                      <div className="text-center"><div className="w-full h-16 bg-gray-500 rounded-lg mb-2"></div><span className="text-xs text-gray-600 dark:text-gray-400">Neutral</span></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { key: 'monthlyReport', label: 'Monthly Reports', desc: 'Receive monthly financial summary reports' },
                    { key: 'billReminders', label: 'Bill Reminders', desc: 'Reminders for upcoming recurring payments' },
                    { key: 'unusualSpending', label: 'Unusual Spending Alerts', desc: 'Detect and notify unusual spending patterns' },
                  ].map(({ key, label, desc }) => (
                  ...
                  <div className="p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2"><Download className="text-primary-600" size={20} /><h4 className="font-semibold text-gray-800 dark:text-gray-200">Export Data</h4></div>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Download all your transactions, budgets, and settings as a JSON file</p>
                      </div>
                      <button onClick={handleExportAllData} className="btn-primary ml-4">Export</button>
                    </div>
                  </div>
                  <div className="p-4 border-2 border-gray-200 dark:border-gray-700 rounded-lg">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2"><Upload className="text-blue-600" size={20} /><h4 className="font-semibold text-gray-800 dark:text-gray-200">Import Data</h4></div>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Restore your data from a previously exported JSON file</p>
                      </div>
                      <label className="btn-secondary ml-4 cursor-pointer">Import<input type="file" accept=".json" onChange={handleImportData} className="hidden" /></label>
                    </div>
                  </div>
                  <div className="p-4 border-2 border-yellow-200 dark:border-yellow-900 rounded-lg">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2"><RefreshCw className="text-yellow-600" size={20} /><h4 className="font-semibold text-gray-800 dark:text-gray-200">Reset Settings</h4></div>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Reset all settings to their default values (keeps your data)</p>
                      </div>
                      <button onClick={handleResetSettings} className="btn-secondary ml-4">Reset</button>
                    </div>
                  </div>
                  <div className="p-4 border-2 border-red-200 dark:border-red-900 rounded-lg">
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2"><Trash2 className="text-red-600" size={20} /><h4 className="font-semibold text-red-600 dark:text-red-400">Clear All Data</h4></div>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Permanently delete all transactions and budgets (cannot be undone)</p>
                      </div>
                      <button onClick={handleClearAllData} className="btn-danger ml-4">Clear Data</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="card">
                ...
                <div className="space-y-4">
                  <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Your financial data is stored locally in your browser using localStorage. Data is encrypted and never sent to external servers.</p>
                  </div>
                  <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Privacy</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400">We don't collect, store, or share any of your personal or financial information. All data remains on your device.</p>
                  </div>
                  <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Session Security</h4>
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">For enhanced security, you can enable automatic logout after inactivity.</p>
